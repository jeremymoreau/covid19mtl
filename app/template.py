...
from .core import (cases_per100_000_long, data_mtl, data_mtl_death_loc, data_qc, data_qc_hosp, latest_cases_mtl,
...
def generate_layout(labels):
    # Figures #####
    mtlmap_fig = figures.mtl_cases_map_fig(cases_per100_000_long, mtl_geojson, labels)
