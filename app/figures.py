...
def mtl_cases_map_fig(cases_per1000_long, mtl_geojson, labels):
    ...
    mtlmap_fig = px.choropleth_mapbox(cases_per1000_long, geojson=mtl_geojson,
...
def mtl_age_hist_fig(mtl_age_data, labels):
    ...
    mtl_age_data_copy['per100000'] = [labels['age_per100000_label']
    ...
    age_fig = px.bar(mtl_age_data_copy, x='age_group', y='percent',
    ...
    age_fig.update_traces(y=age_fig.frames[-1].data[0].y,
                            selector=dict(marker_color='#636efa'))  # frame
    age_fig.update_traces(y=age_fig.frames[-1].data[1].y,
                            selector=dict(marker_color='#EF553B'))  # frame
...
def deaths_fig(data_mtl, data_qc, labels):
    ...
    deaths_fig = go.Figure({
        ...
        'layout': {
            ...
            'legend': {'bgcolor': 'rgba(255,255,255,0)', 'x': 0, 'y': 1},
            'xaxis': {'tickformat': '%m-%d', 'title': {'text': labels['date_label']}},
            'yaxis': {'title': {'text': labels['deaths_qc_y_label']},
                                'gridcolor' : '#f5f5f5'},
...
def qc_hospitalisations_fig(data_qc, labels):
    ...
    hospitalisations_qc_fig = go.Figure({
        ...
        'layout': {
            ...
            'legend': {'bgcolor': 'rgba(255,255,255,0)', 'x': 0, 'y': 1},
            'xaxis': {'tickformat': '%m-%d', 'title': {'text': labels['date_label']}},
            'yaxis': {'title': {'text': labels['hospitalisations_y_label']},
                                'gridcolor' : '#f5f5f5'},
            'margin': {"r":0,"t":10,"l":30,"b":50},
            'plot_bgcolor': 'rgba(255,255,255,1)',
            'paper_bgcolor': 'rgba(255,255,255,1)',
...
def qc_deaths_loc_fig(data_qc_death_loc, labels):
    ...
    deaths_loc_qc_fig = go.Figure({
        ...
        'layout': {
            ...
            'legend': {'bgcolor': 'rgba(255,255,255,0)', 'x': 0, 'y': 1},
            'xaxis': {'tickformat': '%m-%d', 'title': {'text': labels['date_label']}},
            'yaxis': {'title': {'text': labels['deaths_loc_fig_qc_y_label']},
                                'gridcolor': '#f5f5f5'},
            'margin': {"r": 0, "t": 10, "l": 30, "b": 50},
            'plot_bgcolor': 'rgba(255,255,255,1)',
            'paper_bgcolor': 'rgba(255,255,255,1)',
