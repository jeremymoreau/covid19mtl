...
labels = {
    ...
    'yesterday': '昨日',
    'vs_2dago': '较2日前',
    'vaccination_perc_mtl_label': '% received 1 dose (蒙特利尔)',
    'vaccination_perc_qc_label': '% received 1 dose (魁省)',
    'doses_today': '接种量（今日）',
    ...
    'vaccination_hovertemplate': '接种人数: %{y:,df} <br>% of pop received 1 dose: %{customdata[0]:.2f}%',
    ...
    'variants_pos_rate_3d_avg': 'Percent positivity (3-day mov avg)',
