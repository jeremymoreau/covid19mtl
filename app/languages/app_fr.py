...
labels = {
    ...
    'vaccination_perc_mtl_label': '% reçues 1 dose (MTL)',
    'vaccination_perc_qc_label': '% reçues 1 dose (QC)',
    ...
    'vaccination_hovertemplate': 'Doses administrée: %{y:d}<br>% reçues 1 dose: %{customdata[0]:.2f}%',
